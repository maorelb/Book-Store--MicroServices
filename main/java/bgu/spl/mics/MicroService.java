...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>,Callback> mapMsgToCallback;
    ...
    public MicroService(String name) {
        ...
        mapMsgToCallback = new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        mapMsgToCallback.put(type,callback);
     ...
     * {@code callback.call(m)}.
     * <p>
     * @p	private ArrayList<Integer,String> orderSchedule;
aram <B>      The type of broadcast message to subscribe to
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            try {
               ...
               Callback c = mapMsgToCallback.get(m.getClass());
                System.out.println(this.name + " received:  " + m);
               c.call(m);
           }
